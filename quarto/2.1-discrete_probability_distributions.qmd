...
[^1]: [For clarity in the mathematical notation for the more advanced reader refer to](#Probability of Data)
...
Suffice it to say unless otherwise indicated, P(D|M) is to be interpreted in the most literal way, the probability of data given **a** model (note the emphasis on **a**, as in singular).
:::
...
## Appendix on Probability Distributions
