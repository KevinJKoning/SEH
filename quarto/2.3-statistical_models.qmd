...
Due to some poor model assumptions, the probabilities we calculated here do not seem very reasonable. Ultimately this makes P(D|M) non-credible. However, we've also shown some how some fairly simple improvements improved our model substantially. We could also calculate $P(D|M)$ with those models and get much more reasonable results. 
