...
It's worth noting that with the models shown in this chapter, you could calculate probabilities analytically, as we did above. However, another option is to just simulate a large dataset and check the percentile of a data point of interest. We mention the later as it may be the only practical option for more complex problems.