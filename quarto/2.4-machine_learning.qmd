...
"""
# --- Neural network with logistic activation ---
...
class NeuralNetwork:
    ...
    def forward(self, X):
        # First hidden layer with logistic activation.
        self.Z1 = np.dot(X, self.W1) + self.b1
        self.A1 = logistic(self.Z1)
        
        # Second hidden layer with logistic activation.
...
app_ui = ui.page_fluid(
    ui.h2("Neural Network Training with Logistic Activation"),
    ui.layout_sidebar(
        ui.sidebar(
