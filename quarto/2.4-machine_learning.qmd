...
app_ui = ui.page_sidebar(
    sidebar=ui.input_text("node_value", "Set Node Value", value="1"),
    ui.tags.head(
        ui.tags.script(src="https://cdn.jsdelivr.net/npm/mermaid@10/dist/mermaid.min.js")
    ),
    ui.tags.script("""
...
def server(input, output, session):
    ...
    @render.ui
    def mermaid_diagram():
        node_val = input.node_value() or "?"
        node_display = f"= {node_val}"
  ...
  N7 -->|"a_{3,1}"| N8
        ...
        return ui.div(
            ui.tags.div(
                ...
                style="transform: scaleY(0.8); transform-origin: top left;"
            )
        )
