...
I assume most engineers think of *machine learning* as a sexier discipline than statistics. In reality there is a *lot* of blur/overlap from one to the other. Since the reader of this primer will inevitably be interested in machine learning, I think it's best to include it, at the very least so we can understand the similarities and differences to the statistical models that are the focus of the primer.
