...
- In the Frequentist (under which most of the primer has operated) view, the probability of heads with the maximum likelihood is simply P=1, i.e. we expect to always get heads.
