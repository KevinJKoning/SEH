...
**We should include cumulative distances to preview that, and a discussion that we can't find the probability of an exact value, but we can find the probability of greater or lesser**
...
To summarize, the Normal distribution takes additive processes to the limit, in which they generate the perfect 'Bell Curve'. This is a great approximation for many variables, like height - but beware it is the logical extreme - height for example cannot be perfectly Normal, because it cannot have negative values.
...
::: callout-note
We should acknowledge that probability distributions can be used in different ways:
...
For multiple data points, we are interested in the *relative* probability of one series of events vs some other series of events. This is utilizing bullet two from the properties of the probability density function given above.

*Need some discussion of probability of multiple independent events.*
