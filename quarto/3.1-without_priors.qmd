...
When building a candidate model, you must assume a probability distribution for the data. For example, if you assume a normal (Gaussian) distribution, each data point is modeled as:
