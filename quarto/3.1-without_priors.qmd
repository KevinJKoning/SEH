...
It's quite a bit harder to optimize two parameters by hand, but you can always see the Maximium Likelihood Estimate by clicking the 'MLE' button. Also, while there are some good reasons in statistical analysis to default to using normal/gaussian distributions, it's somewhat dangerous to the extent it has implicitly permeated many analyses. Please just keep this in mind when tackling 'real-world' problems.
